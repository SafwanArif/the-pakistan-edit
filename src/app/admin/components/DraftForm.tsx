...
const Slide1Editor = React.memo<{ draft: Draft, onChange: (d: Draft) => void }>(({ draft, onChange }) => (
    <>
        ...
        <span className="tpe-separator-pipe" style={{ color: 'var(--ui-border)', fontSize: '20px', fontWeight: 200, display: 'flex', alignItems: 'center', marginInline: '-6px', pointerEvents: 'none' }}>|</span>
